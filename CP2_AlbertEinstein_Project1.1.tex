...
The log-log plot going from 10 to 990 can be obtained when running the loop in range(100) with M=10*m in the rel() function. The log-log plot going from 1000 to 9000 can be obtained when running that same loop in range(10) with M=1000*m.
...
\section{Workflow}
	...
	\\
	\\
	\underline{\textbf{Laplacian, Hamiltonian and Potential}} \\
	...
	\\
	\\
 	\underline{\textbf{Hamiltonian tests and first wavefunctions}} \\
	...
	\\
 	\underline{\textbf{Second-order integrator}} \\
	...
	\\
	\\
 	\underline{\textbf{Strang-splitting integrator}} \\
	...
	\\
	\\
 	\underline{\textbf{Animating a 1D Gaussian}} \\
