...
def matrix_multi(vector, iterations, error_Hinv, maxiters_Hinv):
    for i in range(iterations):
        w = Hinv(vector, error_Hinv, maxiters_Hinv)[0]
        vector = w
    return vector
...
def arnoldi(number_eigen, error_arnoldi, maxiter_arnoldi, error_Hinv, maxiters_Hinv):
    v = np.ones(N)
...
#print(arnoldi(5,0.0001,100,0.0001,100))   
